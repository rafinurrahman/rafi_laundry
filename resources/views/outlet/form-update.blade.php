    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="outlet/update/{{ $item->id }}" >
            @csrf
            <div class="form-group">
              ...
              <div class="form-group mt-2">
                ...
                <div class="input-group input-group-outline">
                <input type="text" name="telp" value="{{ old('telp') ? old('telp') : $item->telp}}" class="ms-2 form-control @error('telp') is-invalid @enderror" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                @error('telp')
                    <div class="text-muted">{{ $message }}</div>
                @enderror
                </div>
